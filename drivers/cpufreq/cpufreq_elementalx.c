...
#define TRANSITION_LATENCY_LIMIT		(8 * 1000 * 1000)
...
static int two_phase_freq_array[NR_CPUS] = {[0 ... NR_CPUS-1] = 1401600} ;
...
static int input_event_min_freq_array[NR_CPUS] = {1017600} ;
